      ...
      <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3">
        {projects.map((project, index) => (
          <motion.div
            ...
            className="bg-gray-900 border border-white/10 rounded-2xl shadow-[0_0_15px_2px_rgba(130,69,236,0.2)] overflow-hidden cursor-pointer hover:shadow-purple-500/50 hover:-translate-y-2 transition-all duration-300"
          >
            <img
              src={project.image}
              alt={project.title}
